...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_electron__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_electron___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_electron__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fs__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_fs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_path__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_path___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_path__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_electron_window_state__ = __webpack_require__(303);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_electron_window_state___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_electron_window_state__);





const config = JSON.parse(__WEBPACK_IMPORTED_MODULE_1_fs___default.a.readFileSync("package.json"));
...
class ElectonApplication {
  ...
  constructor (app, ipcMain) {
    this.mainWindowState = __WEBPACK_IMPORTED_MODULE_3_electron_window_state___default()({
      defaultWidth: 800,
      defaultHeight: 400
    });

    this.mainWindow = new __WEBPACK_IMPORTED_MODULE_0_electron__["BrowserWindow"]({
  ...
  didFinishLoad () {
    ...
    this.mainWindow.webContents.send('systemPreferences' , __WEBPACK_IMPORTED_MODULE_0_electron__["systemPreferences"]);

  }

  initializeMediaShortcuts () {
    __WEBPACK_IMPORTED_MODULE_0_electron__["globalShortcut"].register('MediaPlayPause', () => {
      this.mainWindow.webContents.send('MediaPlayPause');
    });

    __WEBPACK_IMPORTED_MODULE_0_electron__["globalShortcut"].register('MediaStop', () => {
      this.mainWindow.webContents.send('MediaStop');
    });

    __WEBPACK_IMPORTED_MODULE_0_electron__["globalShortcut"].register('MediaPreviousTrack', () => {
      this.mainWindow.webContents.send('MediaPreviousTrack');
    });

    __WEBPACK_IMPORTED_MODULE_0_electron__["globalShortcut"].register('MediaNextTrack', () => {
  ...
  menuBar () {
    const basicTemplate = [{
      ...
      submenu: [
        ...
        { type: "separator" },
        { label: "Quit", accelerator: "Command+Q", click: function() { __WEBPACK_IMPORTED_MODULE_0_electron__["app"].quit(); }}
      ]}, {
      label: "Edit",
      submenu: [
    ...
    const menu = __WEBPACK_IMPORTED_MODULE_0_electron__["Menu"].buildFromTemplate(basicTemplate);
  ...
  makeTray (name) {
    let file = __WEBPACK_IMPORTED_MODULE_2_path___default.a.join(__dirname, '../' , 'media', name);
    let icon = __WEBPACK_IMPORTED_MODULE_0_electron__["nativeImage"].createFromPath(file);
    icon = icon.resize({
      width: 16,
      height: 16
    })
    let appIcon = new __WEBPACK_IMPORTED_MODULE_0_electron__["Tray"](icon);
  }

  makeIcon(name) {
    let file = __WEBPACK_IMPORTED_MODULE_2_path___default.a.join(__dirname, '../' , 'media', name);
    console.log('file: ', file)
    return __WEBPACK_IMPORTED_MODULE_0_electron__["nativeImage"].createFromPath(file);
  }
...
function initMainWindow() {
  ...
  let application = new ElectonApplication(__WEBPACK_IMPORTED_MODULE_0_electron__["app"], __WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"]);
}

__WEBPACK_IMPORTED_MODULE_0_electron__["app"].on('will-quit', () => {
  // Unregister all shortcuts.
  __WEBPACK_IMPORTED_MODULE_0_electron__["globalShortcut"].unregisterAll()
})
 ...
 */
__WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"].on('maximizeApp', () => {
 ...
 */
__WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"].on('minimizeApp', () => {
  mainWindow.minimize()
});
 ...
 */
__WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"].on('hideApp', () => {
  //mainWindow.hide();
});

__WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"].on('showApp', () => {
  //showAndFocus();
});
 ...
 */
__WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"].on('closeApp', () => {
...
//
__WEBPACK_IMPORTED_MODULE_0_electron__["ipcMain"].on('destroyApp', () => {
  mainWindow.close();
});
...
var electron = __webpack_require__(116);
var jsonfile = __webpack_require__(308);
var mkdirp = __webpack_require__(304);
var deepEqual = __webpack_require__(300);
...
var fs = __webpack_require__(48)
var polyfills = __webpack_require__(307)
...
if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || '')) {
  process.on('exit', function() {
    debug(queue)
    __webpack_require__(310).equal(queue.length, 0)
  })
}

module.exports = patch(__webpack_require__(115))
...
var Stream = __webpack_require__(312).Stream
